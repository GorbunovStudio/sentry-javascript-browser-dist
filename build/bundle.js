/*! @sentry/browser 5.6.3 (54c17c4c) | https://github.com/getsentry/sentry-javascript */
    ...
    ***************************************************************************** */
    ...
    TraceKit._computeStackTrace = (function _computeStackTraceWrapper() {
        ...
        function _computeStackTraceFromStackProp(ex) {
            ...
            gecko = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|capacitor|ionic).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i, winjs = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, 
